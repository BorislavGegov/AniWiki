...
def follow(username: str):
    return follow_unfollow(username, follow=True)


@app.route('/unfollow/<username>', methods=['POST'])
@login_required
def unfollow(username: str):
    return follow_unfollow(username, follow=False)


def follow_unfollow(username: str, follow: bool):
    form = EmptyForm()
